...
module "oidc_provider" {
  source = "github.com/Spartaiis/DevOps//td5/scripts/tofu/modules/github-aws-oidc"
...
module "iam_roles" {
  source = "github.com/Spartaiis/DevOps//td5/scripts/tofu/modules/gh-actions-iam-roles"
